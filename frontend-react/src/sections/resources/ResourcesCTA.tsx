                ...
                <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 border border-slate-800 shadow-[0_40px_80px_rgba(0,0,0,0.2)] text-center relative overflow-hidden group">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
                        ...
                        >
                            ...
                            <Link to="/#success_stories" className="h-16 px-12 rounded-full bg-white/5 border border-white/10 text-white text-sm font-medium hover:bg-white hover:text-slate-900 transition-all w-full sm:w-auto flex items-center justify-center">
