        ...
        <div className="bg-brand-black min-h-screen pt-32 pb-20">
            <div className="container mx-auto px-6 max-w-4xl">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-brand-white mb-4">Why Companies Switch to KOMP</h1>
                ...
                <div className="bg-[#0f0f0f] border border-brand-white/10 rounded-2xl p-8">
                    ...
                    <ComparisonRow feature="100% Indemnified Compliance" komp={true} others={false} /> {/* Assuming KOMP wins here effectively */}
