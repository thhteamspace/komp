...
import { Rocket, Merge, Shield } from 'lucide-react';

const TransitionWorkflow = () => {
    const phases = [
        {
            title: "Phase 1: Startup Enablement",
            desc: "Provided instant EOR capabilities to hire top talent anywhere without establishing legal entities, enabling rapid product-market fit velocity.",
            badge: "Velocity Unlocked",
            icon: <Rocket size={24} />,
            side: "left"
        },
        {
            title: "Phase 2: Mid-Market Consolidation",
            desc: "As regional presence grew, Komp integrated diverse payroll streams into one dashboard, standardizing data and reducing administrative overhead.",
            badge: "Systems Unified",
            icon: <Merge size={24} />,
            side: "right"
        },
        {
            title: "Phase 3: Enterprise Control",
            desc: "Full-scale implementation of automated governance and custom reporting layers, giving leadership total command over global operations and spend.",
        ...
        <section className="py-32 lg:py-48 bg-[#f8f6f5]">
            <div className="max-w-5xl mx-auto px-6">
                <div className="text-center mb-24">
                    ...
                    >
                        How KOMP Supported Each Growth Stage
                    </motion.h2>
                    <p className="text-xl text-slate-500 font-medium tracking-tight">A continuous partnership driving evolution from day one.</p>
                </div>
