...
import { Zap, TrendingDown, Eye, ArrowRight } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-center mb-32">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-[1.1] tracking-tighter">
                            "Expansion became continuous rather than disruptive, supported by a <span className="text-brand-orange">platform</span> that evolved alongside the <span className="text-brand-orange">business</span>."
                        </h2>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20 items-center">
                        <div className="flex items-start gap-6 group/stat">
                            ...
                            <div>
                                ...
                                <p className="text-slate-900 font-black text-xl leading-tight tracking-tight">Faster Hiring Cycles</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-6 group/stat">
                            ...
                            <div>
                                ...
                                <p className="text-slate-900 font-black text-xl leading-tight tracking-tight">Reduced Overhead</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-6 group/stat">
                            ...
                            <div>
                                ...
                                <p className="text-slate-900 font-black text-xl leading-tight tracking-tight">Centralized Data Visibility</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="text-center">
                    <p className="text-xl md:text-2xl text-slate-500 mb-12 max-w-3xl mx-auto font-medium">
                        By eliminating the need to rethink global hiring at every stage of growth, Komp empowered the client to focus entirely on their mission, knowing their infrastructure would never hold them back.
                    </p>
                    <Link href="/use-cases/compliance-management">
                        <Button
