...
import { Users, Landmark, Gavel } from 'lucide-react';

const TransitionWorkflow = () => {
    const phases = [
        {
            title: "Phase 1: HR Operations",
            desc: "Centralizing people data and onboarding flows. We established a single portal for all new hires, ensuring consistent data capture from day one.",
            badge: "Unified People Data",
            icon: <Users size={24} />,
            side: "left"
        },
        {
            title: "Phase 2: Finance Operations",
            desc: "Connecting payroll outputs to the general ledger. Finance gained the ability to audit and approve global payroll runs in a single consolidated view.",
            badge: "Real-Time Cost Control",
            icon: <Landmark size={24} />,
            side: "right"
        },
        {
            title: "Phase 3: Legal Oversight",
            desc: "Implementing automated compliance monitoring. Legal teams could now push contract updates globally and receive alerts on local regulatory changes.",
        ...
        <section className="py-32 lg:py-48 bg-[#f8f6f5]">
            <div className="max-w-5xl mx-auto px-6">
                <div className="text-center mb-24">
                    ...
                    >
                        How Team Alignment Was Achieved
                    </motion.h2>
