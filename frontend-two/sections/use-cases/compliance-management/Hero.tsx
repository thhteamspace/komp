    ...
    return (
        <header className="relative bg-[#f8f6f5] py-24 lg:py-48 border-b border-gray-200 overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-6 text-center">
                ...
                >
                    When Global Teams Operate on <br />
                ...
                >
                    How a premium growth platform eliminated cross-functional friction between HR, Finance, and Legal by unifying fragmented data streams into a single source of truth.
                </motion.p>
            </div>
        </header>
    );
