...
import { Rocket, Wallet, Eye, ArrowRight } from 'lucide-react';
        ...
        <section className="bg-white relative overflow-hidden py-32 lg:py-48">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-center mb-32">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-[1.1] tracking-tighter">
                            "Global hiring evolved from a cross-functional burden into a <span className="text-brand-orange">coordinated operating model</span>."
                        </h2>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20 items-center">
                        <div className="flex items-start gap-6 group/stat">
                            ...
                            <div>
                                ...
                                <p className="text-slate-900 font-black text-xl leading-tight tracking-tight">Faster Onboarding Cycles</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-6 group/stat">
                            ...
                            <div>
                                <div className="text-5xl lg:text-6xl font-black text-brand-orange mb-3 tracking-tighter">15%</div>
                                <p className="text-slate-900 font-black text-xl leading-tight tracking-tight">Reduced Cost Leakage</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-6 group/stat">
                            ...
                            <div>
                                ...
                                <p className="text-slate-900 font-black text-xl leading-tight tracking-tight">Improved Compliance Visibility</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="text-center">
                    <Link href="/use-cases/industry-compliance">
                        <Button
