                    ...
                    <div className="relative z-10 grid lg:grid-cols-12 gap-16 items-center">
                        <div className="lg:col-span-5">
                            ...
                            >
                                ...
                                <h3 className="text-3xl md:text-5xl font-black mb-6 leading-[0.95] tracking-tighter">A Shared Operating Layer for HR, Finance, and Legal</h3>
                                <div className="w-16 h-1.5 bg-white/40 mb-8 rounded-full"></div>
                                <p className="text-white/90 font-bold text-xl leading-relaxed">
                                    Unified workflows that bridge departmental silos.
                                </p>
                            </motion.div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            ...
                            <p className="text-xl text-slate-500 font-medium mb-12 leading-relaxed">
                                Komp implemented a Unified Operating Layer that sat above the client's fragmented local systems. Instead of replacing every local provider, Komp acted as the translation layer, ingesting data from disparate endpoints and normalizing it into one command center dashboard.
                            </p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-10">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900">Automated Onboarding</h5>
                                        <p className="text-slate-500 font-medium mt-1">Streamlined employee setup workflows.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-full bg-brand-orange/10 text-brand-orange flex items-center justify-center shrink-0">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900">Unified Funding</h5>
                                        <p className="text-slate-500 font-medium mt-1">Centralized payroll treasury management.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-full bg-brand-orange/10 text-brand-orange flex items-center justify-center shrink-0">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900">Standardized Contracts</h5>
                                        <p className="text-slate-500 font-medium mt-1">Consistent legal frameworks globally.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
