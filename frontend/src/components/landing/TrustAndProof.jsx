            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10">
                ...
                <div className="max-w-4xl mb-24">
                    ...
                    <p className="text-xl md:text-2xl text-gray-500 font-medium max-w-2xl leading-relaxed">
                        This section provides social proof, mentioning case studies or success stories that demonstrate value.
                    </p>
                </div>
                ...
                >
                    <span className="flex items-center gap-3 text-gray-900">
                        <Check size={18} className="text-blue-600" /> Certification 1
                    </span>
                    <span className="flex items-center gap-3 text-gray-900">
                        <Check size={18} className="text-blue-600" /> Certification 2
                    </span>
                    <span className="flex items-center gap-3 text-gray-900">
                        <Check size={18} className="text-blue-600" /> Certification 3
                    </span>
                    <span className="hidden md:block flex-1 border-t border-gray-100" />
                    <span className="text-gray-300">Auditor Name</span>
                </motion.div>
